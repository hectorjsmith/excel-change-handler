...
namespace ExcelChangeHandlerTest.ChangeHandler.Handler
{
    class ActiveChangeProcessorTest
    {
        ...
        {
            IChangeProcessor<IWorksheet, IRange> changeHandler = new ActiveChangeProcessor<IWorksheet, IRange>(new MockLoggingManager(), new Configuration());
        ...
        public void Given_ActiveChangeProcessorWithNoMemory_When_AfterChangeCalled_Then_ChangeHighlighted()
        {
            int testColour = 111;
            IChangeProcessor<IWorksheet, IRange> changeHandler = new ActiveChangeProcessor<IWorksheet, IRange>(new MockLoggingManager(), new Configuration());
            changeHandler.AddHandler(new SimpleChangeHighlighter<IWorksheet, IRange>(new MockLoggingManager(), testColour));
